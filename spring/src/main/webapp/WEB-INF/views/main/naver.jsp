...
<head>
	...
	<title>네이버</title>
	<link rel="stylesheet" href="<%= request.getContextPath()/*주소의 뒤에 오는 글을 의미*/ %>/resources/css/naver.css">
...
<body>
	...
	<div class="box-container-search">
		<div class="container">
            ...
            <div class="box-search">
                <form action="">
                    ...
                    <a href="#" class="btn-v-keyboard">
						...
						<p class="box-msg-keyboard bg-44265f"></p>
					</a>
					...
					<div class="box-auto-box display-none">
						<div class="box-auto-up">현재 자동 완성 기능을 사용하고 계십니다.</div>
			...
			<div class="box-container-service">
				...
				<a href="//jr.naver.com/" class="link-jr">
					<i class="icon-jr bg-44265f"></i>
				</a>
				<a href="//happybean.naver.com/" class="link-happybean">
		...
		<div class="box-container-servicelist display-none">
			<div class="container display">
				...
				<div class="box-list-service">
					...
					<a href="#" class="link-service">쥬소록</a>
				...
				<div class="box-list-service">
					...
					<a href="#" class="link-service">학습정보</a>
			...
			<div class="container set display-none">
				...
				<div class="box-list-service">
					...
					<div class="box-service-check"><input type="checkbox" name="" value=""><i class="icon-check bg-44265f"></i>쥬소록</div>
				...
				<div class="box-list-service">
					...
					<div class="box-service-check"><input type="checkbox" name="" value=""><i class="icon-check bg-44265f"></i>학습정보</div>
	...
	<div class="box-container-contents">
					...
					<div class="box-group-contents">
						...
						<div class="box-row">
							<div class="box-thumb-area">
								<div class="box-news">
									<img height="20px" alt="" class="" src="https://s.pstatic.net/static/newsstand/2020/logo/light/0604/015.png">
		...
		<div class="box-right">
					...
					<div class="box-card-nav">
						...
						<a href="#" class="box-card2 card">
							<div class="box-current">
								<strong class="text-cuttent">23.2º</strong>
								<strong class="text-state">흐림</strong>
							</div>
							<div class="box-dgree">
								<span class="text-dgree-max">25.0º</span>
								<span class="text-dgree-min">21.0º</span>
							</div>
			...
			<div class="box-right3">
				<a href="#">
					<img src="https://ssl.pstatic.net/tveta/libs/1291/1291017/1590ca0185997b946191_20200602152747643.jpg" alt="">
				</a>
			</div>
				...
				<div class="box-shop-body">
					<div class="box-goods product">
						<div class="box-shop-control">
							<div class="box-num">
								<div class="current-num">1</div>/ <span class="max-num">19</span></div>
							<div class="box-btn">
						...
						<ul class="list-goods">
							<li class="goods-item">
								<a href="#">
									<img src="https://s.pstatic.net/shopping.phinf/20200626_17/9b5162c2-b2e7-422a-8bac-bb1cbb4b823d.jpg?type=f214_292" lazyimg="https://s.pstatic.net/shopping.phinf/20200626_17/9b5162c2-b2e7-422a-8bac-bb1cbb4b823d.jpg?type=f214_292">
									<p>
										<span>전상품세일+무배</span>
										<span>최대 70%찬스</span>
									</p>
					...
					<div class="box-mall mall">
						<div class="box-shop-control">
							<div class="box-num">
								<div class="current-num">1</div>/ <span class="max-num">13</span></div>
							<div class="box-btn">
								<a href="#" class="btn-prev"></a>
								<a href="#" class="btn-next"></a>
							</div>
					...
					<div class="box-goods men">
						<div class="box-shop-control">
							<div class="box-num">
								<div class="current-num">1</div>/ <span class="max-num">6</span></div>
							<div class="box-btn">
								<a href="#" class="btn-prev"></a>
								<a href="#" class="btn-next"></a>
							</div>
	...
	<!-- 오타방지를 위해서 html의 script에서 작성 후 naver.js로 옮겨도 가능 -->
